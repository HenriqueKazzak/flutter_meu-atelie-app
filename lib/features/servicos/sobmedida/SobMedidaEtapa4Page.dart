...
class SobMedidaEtapa4Page extends StatefulWidget {
  final Servico servico;

  const SobMedidaEtapa4Page({Key? key, required this.servico}) : super(key: key);

  @override
  _SobMedidaEtapa4PageState createState() => _SobMedidaEtapa4PageState();
}

class _SobMedidaEtapa4PageState extends State<SobMedidaEtapa4Page> {
